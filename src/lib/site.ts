...
export const site = {
  ...
  // Credibility strip, shown under the hero. PM signal leads.
  proof: [
    "ex-PM @ Rekro",
    "MS AI @ UNSW",
  ...
  // Work-authorization + availability. Recruiters filter hard on this.
  availability: "Full Australian work rights (485 visa). Open to sponsorship. Available now.",
